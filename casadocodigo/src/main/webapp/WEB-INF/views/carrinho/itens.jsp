...
<section class="container middle">
    ...
    <table id="cart-table">
        ...
        <c:forEach items="${carrinhoCompras.itens }" var="item">
            <tr>
                ...
                <td class="numeric-cell">${item.precos }</td>
                ...
                <td class="remove-item">
                    <form action="${s:mvcUrl('CCC#remover').arg(0, item.produto.id).arg(1, item.preco).build()}" method="POST">
    ...
    <ul id="collection" class="related-books">
        <li class="col-left"><a href="/products/livro-plsql" class="block clearfix book-suggest"
                                data-book="PL/SQL: Domine a linguagem do banco de dados Oracle"> <img width="113px"
                                                                                                      height="160px"
        ...
        <div id="social-footer">
            ...
            <ul>
                <li class="social-links"><a href="http://www.twitter.com/casadocodigo" target="_blank" id="twitter"
                        ...
                        href="http://www.facebook.com/casadocodigo" target="_blank" id="facebook"
